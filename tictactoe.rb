class TicTacToe
   ...
   class Game
       ...
       def introduction
            puts "Bienvenues sur TICTACTOE. nous allons choisir qui va commencer au hasard. Apppuyez sur une touche pour commencer."
            puts ""
            @@input = gets.chomp
        end
       ...
       def announce_winner(x)
           ...
           if @x == true
                puts "Vous avez gagné, felicitation !"
                display_board(@winning)
                exit
            else
                return
